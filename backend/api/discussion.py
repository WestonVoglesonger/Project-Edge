...
def create_discussion(discussion: DiscussionCreate, discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
    try:
...
def read_discussion(discussion_id: int, discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
    try:
...
def read_discussions(discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
...
def read_discussions_by_user(author_id: int, discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
...
def update_discussion(discussion_id: int, discussion_update: DiscussionUpdate, discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
    try:
...
def delete_discussion(discussion_id: int, discussion_service: DiscussionService = Depends(get_discussion_service), current_user: UserResponse = Depends(get_current_user)):
    try:
