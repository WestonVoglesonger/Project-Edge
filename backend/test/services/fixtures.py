...
from backend.test.services.demo_data import join_request_data, user_data, project_data, discussion_data, comment_data
...
@pytest.fixture
def join_request_svc(session: Session):
    return JoinRequestService(db=session)
