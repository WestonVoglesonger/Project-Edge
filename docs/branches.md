...
## Edge Carolina Branching Conventions
...
* Catching your team's `stage` branch up with Edge Carolina production's `main` branch
...
[Here is an example of a PR from the UNC CSXL Site that follows this template](https://github.com/unc-csxl/csxl.unc.edu/pull/107). 
